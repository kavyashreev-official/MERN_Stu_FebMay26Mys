...
// We use this: 
// Muiltple child components need to share the same data
...
export function SharedStateParent(){
    // name- name given by parent
    // setName- can modify  inmutable data (name)(it is user name i.e can name it as setName12 also)
